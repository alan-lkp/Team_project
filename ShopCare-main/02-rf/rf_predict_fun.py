...
class RFPredictor(BaseTicketPredictor):
    ...
    def load(self, force=False):
        ...
        try:
            ...
            self.cfg.label_threshold = bundle.get('label_threshold', self.cfg.label_threshold)
            self.cfg.global_threshold = bundle.get('global_threshold', self.cfg.global_threshold)
            self._loaded = True
...
if __name__ == '__main__':
    ...
    print('特征模式:', predictor.bundle_meta.get('feature_mode'),
          '| 训练时间:', predictor.bundle_meta.get('trained_at'))
